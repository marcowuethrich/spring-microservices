package ch.acme.departmentservice;
...
@SpringBootApplication(scanBasePackages = "ch.acme.departmentservice")
@EnableDiscoveryClient
@EnableSwagger2
@EnableFeignClients(basePackages = "ch.acme.departmentservice.client")
public class DepartmentServiceApplication {
    ...
    public Docket swaggerPersonApi10() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("ch.acme.departmentservice.controller"))
